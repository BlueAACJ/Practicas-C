...
void logo(void){
int f--ont = 3,i=1,j=0,inc=0,bandera=0 ;
/*font direction */
int direction = 0;
/* font size */
	int font_size = 5;
...
outtextxy(55,332,"EDUARDO PAIZ -- CARNET:2018-0379U");
outtextxy(55,352, "YASSER CAJINA --CARNET:2018-0161U");
inc=30*j;
while(i<=10){     /*condicion original <= 5 */
/*------logo UNI---------*/
setcolor(LIGHTGRAY);
setfillstyle(SOLID_FILL,LIGHTGRAY);
bar(1+j*2,1,639+j*2,479);
setcolor(BLUE);

setfillstyle(SOLID_FILL,BLUE);
bar(200+inc,64,221+inc,166);
bar(200+inc,150,315+inc,177);
bar(288+inc,170,315+inc,101);
bar(249+inc,138,279+inc,65);
bar(252+inc,79,351+inc,65);
bar(266+inc,72,351+inc,89);
bar(336+inc,66,363+inc,177);
bar(335+inc,69,362+inc,65);
bar(338+inc,161,398+inc,177);
bar(339+inc,154,398+inc,167);
bar(380+inc,162,405+inc,104);
bar(388+inc,151,405+inc,177);
bar(378+inc,65,407+inc,95);
/*---------------------*/
font_size=5;
settextstyle(font, direction, font_size);
setcolor(BLUE);
...
outtextxy(55,312,"MARIA FELIX HERRERA TABLADA -- CARNET:2019-1145U");
outtextxy(55,332,"EDUARDO PAIZ -- CARNET:2018-0379U");
outt+extxy(55,352, "YASSER CAJINA --CARNET:2018-0161U");
/*-------------*/
sleep(1);
setcolor(5);
font_size =5;
...
outtextxy(140,110," animacion 1, presionar '+'para agrandar en cuadro");
outtextxy(140,130," animacion 1, presionar '-'para reducir el cuadro");
outtextxy(140,150," animacion 1, presionar 'esc' para salir");
outtextxy(140,210,"animacion 2, presionar 'esc 'para salir");
outtextxy(10,260,"animacion 3, al terminar de dar la ola completa presionar 'esc' para salir'");
outtextxy(80,300,"animacion 4, alas 2 vueltas el avioncito presionar 'esc' para salir");
getch();
clearviewport();
}
...
outtextxy(50,210,"Creado por: Maria Tablada - 2019-1115u");
outtextxy(70,230,"Eduardo paiz - 2018-0379u");
outtextxy(90,250,"Yasser cajina -2018-0161u");
outtextxy(310,270,"Grupo:  2M5-CO");
outtextxy(235,300,"materia: GEOMETRIA COMPUTACIONAL");
outtextxy(250,320,"profesor: PROF. RHENE BERROTERAN");
getch();
clearviewport();
}
